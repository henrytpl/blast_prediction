...
st.markdown("## Damage Prediction of CFRP-retrofitted RC Beams under Blast Loading")

st.markdown("### Input Parameters")

col1, col2, col3 = st.columns(3)
W  = col1.slider(r"Beam width, $W$ (mm)", 250, 500, 300, step=10)
WD = col2.slider(r"Width-to-depth ratio, $W/D$", 0.35, 1.25, 0.6, step=0.01)
...
fc = col7.slider(r"Conc. compressive strength, $f_c$ (MPa)", 20, 40, 30, step=5)
fy = col8.slider(r"Steel yield strength, $σ_y$ (MPa)", 420, 690, 520, step=10)
...
if st.button("Predict"):
    ...
    pred = max(0, np.round(float(pred), 2))
